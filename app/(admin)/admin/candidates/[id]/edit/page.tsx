...
export default function EditCandidatePage() {
  ...
  function removeLanguage(value: string) {
    setLanguagesList((prev) => prev.filter((item) => item !== value));
  }
    ...
    Promise.all([api.getCandidate(id), api.listRecruiters()])
      .then(([candidate, recs]) => {
        ...
        setForm({
          ...
          alt_phone: candidateData.alt_phone ?? "",
          recruiter_id: candidateData.recruiter_id?.toString() ?? "",
          dob_day: candidateData.dob_day ?? "",
          dob_month: candidateData.dob_month ?? "",
          dob_year: candidateData.dob_year ?? "",
          gender: candidateData.gender ?? "",
          marital_status: candidateData.marital_status ?? "",
          interested_position: candidateData.interested_position ?? "",
          current_location: candidateData.current_location ?? "",
          permanent_location: candidateData.permanent_location ?? "",
          ...
          year_passed: candidateData.year_passed ?? "",
          current_employer: candidateData.current_employer ?? "",
          current_designation: candidateData.current_designation ?? "",
          employment_type: candidateData.employment_type ?? "",
          total_exp_years: candidateData.total_exp_years?.toString() ?? "",
          total_exp_months: candidateData.total_exp_months?.toString() ?? "",
          ...
          disabilities: candidateData.disabilities ?? "No"
        });
        setLanguagesList(candidateData.languages ?? []);
        setLanguagesInput("");
      })
